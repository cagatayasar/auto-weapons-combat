...
public class CWAxe : CW, ICWCancelTransition
{
    ...
    public CWAxe(Weapon weapon, PlayerEnemyData playerEnemyData, int id, bool isPlayer, ref System.Random rnd)
    ...
    public override void InvokeInitializationEvents()
    {
        ...
        OnAnimatorSetFloat("attackSpeed", "axe_anim_attack", 1f / (actionTimePeriod * weaponInfo.animationNonidlePortionMin));
    }
