...
public class CWSawedOff : CombatWeapon
{
        ...
        : base(weapon, playerEnemyData, id, isPlayer, combatMode, ref rnd)
    {
        ...
        if (weapon.attachment == AttachmentType.FasterReload) {
            stats.firstReloadLength /= DataManager.inst.attachmentAttributes.fasterReload_Multiplier;
            stats.secondReloadLength /= DataManager.inst.attachmentAttributes.fasterReload_Multiplier;
        }
